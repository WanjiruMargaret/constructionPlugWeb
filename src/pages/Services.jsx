    ...
    <div className="services-page">
      ...
      <section className="about-hero">
        ...
        <div className="about-overlay">
          ...
          <div className="about-content">
            ...
            <p>
              Professional procurement and sourcing services for
      ...
      <section>
        ...
        <div className="services-page-header">
          ...
          <p>
            We provide the best sourcing and procurement services
            for construction materials in Kenya.
          </p>
        ...
        <div className="services-page-grid">
          ...
          <div className="service-box">
            ...
            <p>
              We help clients source cement, ballast, sand, steel,
              timber, paint, plumbing and electrical materials.
            </p>
          ...
          <div className="service-box">
            ...
            <p>
              Professional purchasing coordination for
              construction projects.
            </p>
